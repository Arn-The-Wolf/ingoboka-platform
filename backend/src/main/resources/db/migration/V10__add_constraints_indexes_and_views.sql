-- V10: Additional constraints, indexes, and reporting views

CREATE INDEX IF NOT EXISTS idx_claims_policy_status ON claims (policy_id, status);
CREATE INDEX IF NOT EXISTS idx_claims_org_status_v10 ON claims (organization_id, status);
CREATE INDEX IF NOT EXISTS idx_notifications_user_read_v10 ON notifications (user_id, read_at);
