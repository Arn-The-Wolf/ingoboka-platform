...
export default function MarketingLoading() {
  return (
    <div className="space-y-0">
      <Skeleton className="h-16 w-full rounded-none" shimmer />
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-12 lg:px-8">
        <Skeleton className="mx-auto h-10 w-2/3 max-w-lg" shimmer />
        <Skeleton className="mx-auto h-5 w-full max-w-xl" shimmer />
